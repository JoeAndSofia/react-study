...
console.log("testRedux.js-store.getState()", __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getState());

// 每次 state 更新时，打印日志
// 注意 subscribe() 返回一个函数用来注销监听器
console.log("start subscribe")
let unsubscribe = __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].subscribe(() => {
		console.log("testRedux.js-store.getState()-2", __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getState());
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducers__ = __webpack_require__(25);
